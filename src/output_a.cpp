#ifndef _OUTPUT_A_CPP_
#define _OUTPUT_A_CPP_
...
bool Output_A::execute() {//Output append: creates a new file if there isn't one and if there is one, writtes to the end of it
  ...
  int file_fd = open(filepath.c_str(), O_WRONLY |  O_CREAT | O_APPEND, S_IRUSR | S_IWUSR | S_IRGRP | S_IROTH);
